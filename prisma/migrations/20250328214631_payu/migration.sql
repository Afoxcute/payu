...
-- CreateEnum
CREATE TYPE "Currency" AS ENUM ('USD', 'EUR', 'GBP', 'MXN');

-- CreateEnum
CREATE TYPE "CurrencyType" AS ENUM ('FIAT');
...
-- CreateIndex
CREATE INDEX "telegram_idx" ON "User"("telegramId");

-- CreateIndex
CREATE INDEX "phone_idx" ON "User"("phone");

-- CreateIndex
CREATE INDEX "telegram_username_idx" ON "User"("telegramUsername");
